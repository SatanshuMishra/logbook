...
const NUDGE_TEXT =
  'Logbook: this session is approaching the compaction threshold. Consider running the debrief skill now to refresh the spine and hand off the active thread before context is compacted.';
